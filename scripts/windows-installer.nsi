...
!define GROUPNAME "Biblecoin"
!define HELPURL "https://github.com/biblecoin/mist/releases/issues"
!define UPDATEURL "https://github.com/biblecoin/mist/releases"
!define ABOUTURL "https://biblecoin.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Biblecoin"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "biblecoind incoming peers (TCP:27330)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\biblecoind\unpacked\BibleCoind.exe" "" "" "Biblecoin" 27330 "" "" ""
    #SimpleFC::AdvAddRule "biblecoind outgoing peers (TCP:27330)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\biblecoind\unpacked\BibleCoind.exe" "" "" "Biblecoin" "" 27330 "" ""
    #SimpleFC::AdvAddRule "biblecoind UDP discovery (UDP:27330)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\biblecoind\unpacked\BibleCoind.exe" "" "" "Biblecoin" "" 27330 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "biblecoind incoming peers (TCP:27330)"
    #SimpleFC::AdvRemoveRule "biblecoind outgoing peers (TCP:27330)"
    #SimpleFC::AdvRemoveRule "biblecoind UDP discovery (UDP:27330)"
