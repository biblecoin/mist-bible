...
// should be       'https://raw.githubusercontent.com/biblecoin/mist/master/clientBinaries.json'
const BINARY_URL = 'https://raw.githubusercontent.com/biblecoin/mist/master/clientBinaries.json';

const ALLOWED_DOWNLOAD_URLS_REGEX =
    /^https:\/\/(?:(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?\.)?biblecoin\.org\/|gethstore\.blob\.core\.windows\.net\/|bintray\.com\/artifact\/download\/karalabe\/biblecoin\/)(?:.+)/;  // eslint-disable-line max-len
...
class Manager extends EventEmitter {
    ...
    _checkForNewConfig(restart) {
        ...
        .then((localConfig) => {
            ...
            return mgr.init({
                folders: [
                    path.join(Settings.userDataPath, 'binaries', 'biblecoind', 'unpacked'),
