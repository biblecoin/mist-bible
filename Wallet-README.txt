...
The Biblecoin wallet, which allows you to create simple and multisig wallets to manage your ether.
...
On OSX its `~/Library/Biblecoin/BibleCoind.ipc` on linux `~/.biblecoin/BibleCoind.ipc` and on windows it uses a named pipe, which doesn't need to be renamed.

Example:

    $ BibleCoind --datadir /my/chain/ --networkid 23 --ipcpath ~/Library/Biblecoin/BibleCoind.ipc
...
- Mac: ~/Library/Biblecoin
- Windows: %APPDATA%\Roaming\Biblecoin
- Linux: ~/.biblecoin
...
https://github.com/biblecoin/meteor-dapp-wallet/issues
...
https://github.com/biblecoin/meteor-dapp-wallet

And the binary application code, which wraps the wallet app can be found at   
https://github.com/biblecoin/mist/tree/wallet
...
https://github.com/biblecoin/mist/tree/wallet#deployment
